...
do
      ...
      cp $1/$protein/1/algorithm/res_gen_1.norm_fitness statistics/$2/$protein/res_first_frontier.norm_fitness
      cp $1/$protein/1/algorithm/res_gen_$4.norm_fitness statistics/$2/$protein/res_last_frontier.norm_fitness
